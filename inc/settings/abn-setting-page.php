<div class="wrap">
    <h2><?php echo __('Settings', 'animal-by-name') ?></h2>
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            <tr valign="top">
                <th scope="row"><label for="abn_text_for_confirm_my_name"><?php echo __('Text For Confirm Name Button', 'animal-by-name') ?></label></th>
                <td>
            ...
            <tr valign="top">
                <th scope="row">
                    <label for="abn_confirm_my_name_button_color"><?php echo __('Confirm Name Button Color', 'animal-by-name') ?></label>
                </th>
                <td>
            ...
            <tr valign="top">
                <th scope="row"><label for="abn_text_for_validate_my_name"><?php echo __('Text For Validate my personalization', 'animal-by-name') ?></label></th>
                <td>
            ...
            <tr valign="top">
                <th scope="row"><label for="abn_validate_my_personalization_button_color"><?php echo __('Validate my personalization Button Color', 'animal-by-name') ?></label></th>
